package net.plshark.usererror.server.role

import kotlinx.coroutines.flow.toList
import kotlinx.coroutines.runBlocking
import net.plshark.usererror.role.ApplicationCreate
import net.plshark.usererror.role.RoleCreate
import net.plshark.usererror.server.role.impl.ApplicationsRepositoryImpl
import net.plshark.usererror.server.role.impl.RolesRepositoryImpl
...
class RolesRepositoryImplTest {
    ...
    private lateinit var repo: RolesRepositoryImpl
    private lateinit var appsRepo: ApplicationsRepositoryImpl

    @BeforeEach
    fun setup(db: DatabaseClient) {
        repo = RolesRepositoryImpl(db)
        appsRepo = ApplicationsRepositoryImpl(db)
    }
