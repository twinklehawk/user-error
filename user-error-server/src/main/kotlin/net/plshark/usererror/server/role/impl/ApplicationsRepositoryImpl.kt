...
import net.plshark.usererror.server.role.ApplicationsRepository
...
/**
 * Applications repository that uses spring data and r2dbc
 */
@Repository
class ApplicationsRepositoryImpl(private val client: DatabaseClient) : ApplicationsRepository {
